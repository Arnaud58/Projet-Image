...
lookup_windows.MeanRGBSameSizeTemplate.prototype.process=function(in_imageData) {
  ...
  //var similarity_task=new pixels_similarity.HistoColorSimilarityTask(lookup_dataset,{});
  //var similarity_task=new pixels_similarity.GridHistoColorSimilarityTask(lookup_dataset,{});
  //var similarity_task=new pixels_similarity.GridMeanRGBASimilarityTask(lookup_dataset,{});
